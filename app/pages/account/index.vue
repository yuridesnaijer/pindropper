...
<template>
  <div>
    ...
    <UContainer v-else>
      <ClientOnly>
        <LMap style="height: 350px" :zoom="6" :center="[coords.latitude, coords.longitude]" :use-global-leaflet="false">
      ...
      <div class="flex justify-center my-8">
        <UButton size="xl" @click="isModalOpen = true" label="Save your current location" />
      </div>
      <UModal v-model:open="isModalOpen" title="Save this location" :dismissible="true">
        <template #body>
          <SaveLocationForm @upload-successful="handleUploadSuccess" :coords="coords" />
        </template>
      </UModal>
